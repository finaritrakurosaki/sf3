...
!function(e){e.fn.extend({slimScroll:function(i){var o={width:"auto",height:"250px",size:"7px",color:"#000",position:"right",distance:"1px",start:"top",opacity:.4,alwaysVisible:!1,disableFadeOut:!1,railVisible:!1,railColor:"#333",railOpacity:.2,railDraggable:!0,railClass:"slimScrollRail",barClass:"slimScrollBar",wrapperClass:"slimScrollDiv",allowPageScroll:!1,wheelStep:20,touchScrollStep:200,borderRadius:"7px",railBorderRadius:"7px"},a=e.extend(o,i);return this.each(function(){function o(t){if(h){var t=t||window.event,i=0;t.wheelDelta&&(i=-t.wheelDelta/120),t.detail&&(i=t.detail/3);var o=t.target||t.srcTarget||t.srcElement;e(o).closest("."+a.wrapperClass).is(E.parent())&&r(i,!0),t.preventDefault&&!y&&t.preventDefault(),y||(t.returnValue=!1)}}function r(e,t,i){y=!1;var o=e,r=E.outerHeight()-T.outerHeight();if(t&&(o=parseInt(T.css("top"))+e*parseInt(a.wheelStep)/100*T.outerHeight(),o=Math.min(Math.max(o,0),r),o=e>0?Math.ceil(o):Math.floor(o),T.css({top:o+"px"})),v=parseInt(T.css("top"))/(E.outerHeight()-T.outerHeight()),o=v*(E[0].scrollHeight-E.outerHeight()),i){o=e;var s=o/E[0].scrollHeight*E.outerHeight();s=Math.min(Math.max(s,0),r),T.css({top:s+"px"})}E.scrollTop(o),E.trigger("slimscrolling",~~o),l(),c()}function s(){window.addEventListener?(this.addEventListener("DOMMouseScroll",o,!1),this.addEventListener("mousewheel",o,!1)):document.attachEvent("onmousewheel",o)}function n(){f=Math.max(E.outerHeight()/E[0].scrollHeight*E.outerHeight(),m),T.css({height:f+"px"});var e=f==E.outerHeight()?"none":"block";T.css({display:e})}function l(){if(n(),clearTimeout(p),v==~~v){if(y=a.allowPageScroll,b!=v){var e=0==~~v?"top":"bottom";E.trigger("slimscroll",e)}}else y=!1;return b=v,f>=E.outerHeight()?void(y=!0):(T.stop(!0,!0).fadeIn("fast"),void(a.railVisible&&H.stop(!0,!0).fadeIn("fast")))}function c(){a.alwaysVisible||(p=setTimeout(function(){a.disableFadeOut&&h||u||d||(T.fadeOut("slow"),H.fadeOut("slow"))},1e3))}var h,u,d,p,g,f,v,b,w="<div></div>",m=30,y=!1,E=e(this);if(E.parent().hasClass(a.wrapperClass)){var S=E.scrollTop();if(T=E.parent().find("."+a.barClass),H=E.parent().find("."+a.railClass),n(),e.isPlainObject(i)){if("height"in i&&"auto"==i.height){E.parent().css("height","auto"),E.css("height","auto");var x=E.parent().parent().height();E.parent().css("height",x),E.css("height",x)}if("scrollTo"in i)S=parseInt(a.scrollTo);else if("scrollBy"in i)S+=parseInt(a.scrollBy);else if("destroy"in i)return T.remove(),H.remove(),void E.unwrap();r(S,!1,!0)}}else if(!(e.isPlainObject(i)&&"destroy"in i)){a.height="auto"==a.height?E.parent().height():a.height;var C=e(w).addClass(a.wrapperClass).css({position:"relative",overflow:"hidden",width:a.width,height:a.height});E.css({overflow:"hidden",width:a.width,height:a.height,"-ms-touch-action":"none"});var H=e(w).addClass(a.railClass).css({width:a.size,height:"100%",position:"absolute",top:0,display:a.alwaysVisible&&a.railVisible?"block":"none","border-radius":a.railBorderRadius,background:a.railColor,opacity:a.railOpacity,zIndex:90}),T=e(w).addClass(a.barClass).css({background:a.color,width:a.size,position:"absolute",top:0,opacity:a.opacity,display:a.alwaysVisible?"block":"none","border-radius":a.borderRadius,BorderRadius:a.borderRadius,MozBorderRadius:a.borderRadius,WebkitBorderRadius:a.borderRadius,zIndex:99}),M="right"==a.position?{right:a.distance}:{left:a.distance};H.css(M),T.css(M),E.wrap(C),E.parent().append(T),E.parent().append(H),a.railDraggable&&T.bind("mousedown",function(i){var o=e(document);return d=!0,t=parseFloat(T.css("top")),pageY=i.pageY,o.bind("mousemove.slimscroll",function(e){currTop=t+e.pageY-pageY,T.css("top",currTop),r(0,T.position().top,!1)}),o.bind("mouseup.slimscroll",function(e){d=!1,c(),o.unbind(".slimscroll")}),!1}).bind("selectstart.slimscroll",function(e){return e.stopPropagation(),e.preventDefault(),!1}),H.hover(function(){l()},function(){c()}),T.hover(function(){u=!0},function(){u=!1}),E.hover(function(){h=!0,l(),c()},function(){h=!1,c()}),window.navigator.msPointerEnabled?(E.bind("MSPointerDown",function(e,t){e.originalEvent.targetTouches.length&&(g=e.originalEvent.targetTouches[0].pageY)}),E.bind("MSPointerMove",function(e){if(e.originalEvent.preventDefault(),e.originalEvent.targetTouches.length){var t=(g-e.originalEvent.targetTouches[0].pageY)/a.touchScrollStep;r(t,!0),g=e.originalEvent.targetTouches[0].pageY}})):(E.bind("touchstart",function(e,t){e.originalEvent.touches.length&&(g=e.originalEvent.touches[0].pageY)}),E.bind("touchmove",function(e){if(y||e.originalEvent.preventDefault(),e.originalEvent.touches.length){var t=(g-e.originalEvent.touches[0].pageY)/a.touchScrollStep;r(t,!0),g=e.originalEvent.touches[0].pageY}})),n(),"bottom"===a.start?(T.css({top:E.outerHeight()-T.outerHeight()}),r(0,!0)):"top"!==a.start&&(r(e(a.start).position().top,null,!0),a.alwaysVisible||T.hide()),s()}}),this}}),e.fn.extend({slimscroll:e.fn.slimScroll})}(jQuery);
...
!function(t,e,i,n){"use strict";function s(e,i){this.element=e,this.settings=t.extend({},a),this._defaults=a,this._name=o,this.init()}var o="easyAdminSticky",a={stickyClass:"stuck",placeholderClass:"sticky-wrapper",sidebarDuration:300,bottomOffset:15};t.extend(s.prototype,{init:function(){this._createPlaceholder(),this._initWaypoint(),this._bindWindowResizeEvent(),this._bindAdminLteSidebarEvents(),this._bindCkEditorEvent()},_createPlaceholder:function(){this.$placeholder=t("<div>").attr("class",t(this.element).attr("class")).removeClass(this.settings.stickyClass).addClass(this.settings.placeholderClass).insertAfter(this.element)},_initWaypoint:function(){var i=this;this.waypoint=new Waypoint({element:i.$placeholder[0],offset:function(){return this.context.innerHeight()-this.adapter.outerHeight()+i.settings.bottomOffset},handler:function(e){var n=t(i.element);i.$placeholder.height(0),n.removeClass(i.settings.stickyClass).css("width","100%"),"up"===e&&i._createStickyFooter()}}),t(e).height()>i.waypoint.triggerPoint&&i._createStickyFooter()},_bindAdminLteSidebarEvents:function(){var e=this;t(i).on("collapsed.pushMenu expanded.pushMenu",function(){setTimeout(function(){e._refreshWaypointAndWidth()},e.settings.sidebarDuration)})},_bindWindowResizeEvent:function(){var i=this;t(e).on("resize",function(){var t=function(){setTimeout(function(){i._refreshWaypointAndWidth()},i.settings.sidebarDuration)};i._debounce(t(),250)})},_bindCkEditorEvent:function(){if("undefined"!=typeof CKEDITOR){var t=this;CKEDITOR.on("instanceReady",function(e){t.waypoint.context.refresh()})}},_createStickyFooter:function(){var e=t(this.element);this.$placeholder.height(e.height()),e.addClass(this.settings.stickyClass).width(this.$placeholder.width())},_refreshWaypointAndWidth:function(){this.waypoint.context.refresh(),t(this.element).width(this.$placeholder.width())},_debounce:function(t,e,i){var n;return function(){var s=this,o=arguments,a=function(){n=null,i||t.apply(s,o)},r=i&&!n;clearTimeout(n),n=setTimeout(a,e),r&&t.apply(s,o)}}}),t.fn[o]=function(e){return this.each(function(){t.data(this,"plugin_"+o)||t.data(this,"plugin_"+o,new s(this,e))})}}(jQuery,window,document);
...
function createNullableControls(){var e=function(){var e=$(this);e.closest(".form-group").find("select").each(function(){var t=e.is(":checked");$(this).prop("disabled",t),t?$(this).parent().slideUp({duration:200}):$(this).parent().slideDown({duration:200})})};$(".nullable-control :checkbox").bind("change",e).each(e)}function toggleNavigation(e){var t="_easyadmin_navigation_iscollapsed";return function(){e?createPersistentCookie(t,!0):deleteCookie(t)}}function createPersistentCookie(e,t){document.cookie=encodeURIComponent(e)+"="+encodeURIComponent(t)+"; path=/; expires=Fri, 31 Dec 9999 23:59:59 GMT"}function deleteCookie(e){document.cookie=encodeURIComponent(e)+"=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT"}function createAutoCompleteFields(){var e=$("[data-EasyAdmin-autocomplete-url]");e.each(function(){var e=$(this),t=e.data("EasyAdmin-autocomplete-url");e.select2({theme:"bootstrap",ajax:{url:t,dataType:"json",delay:250,data:function(e){return{query:e.term,page:e.page}},processResults:function(e,t){return{results:e.results,pagination:{more:e.has_next_page}}},cache:!0},placeholder:"",allowClear:!0,minimumInputLength:1})})}$(function(){var e=$("body");e.on("expanded.pushMenu",toggleNavigation(!1)).on("collapsed.pushMenu",toggleNavigation(!0)),createNullableControls(),createAutoCompleteFields()});
