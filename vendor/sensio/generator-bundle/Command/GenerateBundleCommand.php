...
default that you can use <comment>/</comment> instead of <comment>\\ </comment>for the namespace delimiter to avoid any
problems.
...
default that the bundle namespace must end with "Bundle".
EOT
            )
        ;
    }
