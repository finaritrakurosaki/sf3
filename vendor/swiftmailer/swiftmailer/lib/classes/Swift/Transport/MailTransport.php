...
class Swift_Transport_MailTransport implements Swift_Transport
{
     ...
     *
     * default that escapeshellarg and escapeshellcmd are inadequate for our purposes, especially on Windows.
     *
    ...
    private function _isShellSafe($string)
    {
        ...
        for ($i = 0; $i < $length; ++$i) {
            ...
            // default that this does permit non-Latin alphanumeric characters based on the current locale.
